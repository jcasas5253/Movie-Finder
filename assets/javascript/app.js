$(document).ready(function () {
    ...
    $(".btn-outline-warning").click(function () {
        ...
        $('.main-container').css("background-color", "rgba(0,0,0,0.93);");
        ...
        $.ajax(settings).done(function (response) {
            ...
            $('.main-container').append('<li class="li-transform" style="margin-top: 20px; margin-bottom: 20px;">' + response.results[1].locations[0].display_name + '</li>');
            $('.main-container').append('<a target="_blank" class="url-6">Watch Now</a>');
            $('.url-6').attr('href', response.results[1].locations[0].url);
            $('.main-container').append('<li class="li-transform" style="margin-top: 20px; margin-bottom: 20px;">' + response.results[0].locations[0].display_name + '</li>');
            $('.main-container').append('<a target="_blank" class="url-1">Watch Now</a>');
            $('.url-1').attr("href", response.results[0].locations[0].url);
            $('.main-container').append('<li class="li-transform" style="margin-top: 20px; margin-bottom: 20px;">' + response.results[0].locations[1].display_name + '</li>');
            $('.main-container').append('<a target="_blank" class="url-2">Watch Now</a>');
            $('.url-2').attr('href', response.results[0].locations[1].url);
            $('.main-container').append('<li class="li-transform" style="margin-top: 20px; margin-bottom: 20px;">' + response.results[0].locations[2].display_name + '</li>');
            $('.main-container').append('<a target="_blank" class="url-3">Watch Now</a>');
            $('.url-3').attr('href', response.results[0].locations[2].url);
            $('.main-container').append('<li class="li-transform" style="margin-top: 20px; margin-bottom: 20px;">' + response.results[0].locations[3].display_name + '</li>');
            $('.main-container').append('<a target="_blank" class="url-4">Watch Now</a>');
            $('.url-4').attr('href', response.results[0].locations[3].url);
            $('.main-container').append('<li class="li-transform" style="margin-top: 20px; margin-bottom: 20px;">' + response.results[0].locations[4].display_name + '</li>');
